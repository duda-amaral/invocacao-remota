...
public class Main {
    public static void main(String[] args) {
        ...
        try(FileWriter writer = new FileWriter("execucao_calculadora_local.txt", true)) {
            long inicio = System.currentTimeMillis(); // Início do tempo
            ...
            System.out.println("Tempo de execução salvo em execucao_calculadora_local.txt");
        } catch (IOException e) {
